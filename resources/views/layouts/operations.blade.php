...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"> <title>{{ $title ?? 'Operations' }} - Rawabi Travel</title>
...
<body class="bg-gray-50 dark:bg-zinc-950 font-sans antialiased h-screen flex flex-col overflow-hidden text-gray-900 dark:text-zinc-100" 
      x-data="{ 
        mobileMenuOpen: false, // State Global untuk Sidebar Mobile
        ...
        <div class="flex items-center gap-3">
            ...
            @else
                ...
                <div class="flex flex-col">
                    <span class="font-bold text-lg leading-none">OPERATIONAL CENTER</span>
                    <span class="text-[10px] text-gray-500 dark:text-zinc-500 tracking-wider">Manifest & Logistik</span>
                </div>
            @endif
            </div>

        <div class="flex items-center gap-3">
            <button @click="toggleTheme()" class="p-2 rounded-full text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 transition">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" 
                    ...
                    <a href="/admin" class="w-full text-left flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-white/5 transition">
                    ...
                    <form method="POST" action="{{ route('filament.admin.auth.logout') }}">
                        @csrf
                        <button type="submit" class="w-full text-left flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 transition">
    ...
    <main class="flex-1 w-full relative overflow-hidden flex">
